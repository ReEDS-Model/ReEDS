...
Existing exogenous hydrothermal capacity is treated as already discovered; the discovery rate applies only to the remaining resource available for new investment, including prescribed builds.
