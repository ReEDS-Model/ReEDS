...
tsc_binwidth(r,rr,tscbin)$tsc_binwidth(r,rr,tscbin) = round(tsc_binwidth(r,rr,tscbin)*1E-6,2) ;
tsc_forward(r,rr,tscbin)$tsc_forward(r,rr,tscbin) = round(tsc_forward(r,rr,tscbin)*1E-6,2) ;
tsc_reverse(r,rr,tscbin)$tsc_reverse(r,rr,tscbin) = round(tsc_reverse(r,rr,tscbin)*1E-6,2) ;
