...
if(Sw_RemoveSmallNumbers = 1,
    ...
    INV_POI.l(r,icbin,tfix)$[abs(INV_POI.l(r,icbin,tfix)) < rhs_tolerance] = 0 ;
...
INV_POI.fx(r,icbin,tfix)$[Sw_TransIntraCost$poi_bin_feas(r,icbin)] = INV_POI.l(r,icbin,tfix) ;
