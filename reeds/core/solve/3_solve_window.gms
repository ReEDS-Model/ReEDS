...
if(Sw_Int_CC=0,
    cc_int(i,c,v,r,szn,t)$[tload(t)$(vre(i) or storage(i))$valcap_class(i,c,v,r,t)$sum{(vv)$(valcap(i,vv,r,t)), CAP.l(i,vv,r,t) }] =
        cc_old_load(i,r,szn,t) / sum{(vv)$(valcap(i,vv,r,t)), CAP.l(i,vv,r,t) } ;
    cc_int(i,c,v,r,szn,t)$[tload(t)$(vre(i) or storage(i))$valcap_class(i,c,v,r,t)$(cc_old_load(i,r,szn,t)=0)] = m_cc_mar(i,c,r,szn,t) ;
) ;
...
if(Sw_Int_CC=1 or Sw_Int_CC=2,
    cc_int(i,c,v,r,szn,t)$[tload(t)$(vre(i) or storage(i))$valcap_class(i,c,v,r,t)$sum{vv$ivt(i,vv,t), m_cf_szn(i,vv,r,szn,t) }] =
    ...
    cc_totmarg(i,r,szn,t)$[tload(t)$(vre(i) or storage(i))] =
        sum{(c,v)$[valcap_class(i,c,v,r,t)],
...
if(Sw_Int_CC=1,
    ...
    cc_int(i,c,v,r,szn,t)$[tload(t)$(vre(i) or storage(i))$valcap_class(i,c,v,r,t)] = cc_int(i,c,v,r,szn,t) * cc_scale(i,r,szn,t) ;
) ;
...
if(Sw_AVG_iter=1,
        cc_int(i,c,v,r,szn,t)$[tload(t)$(vre(i) or storage(i))$valcap_class(i,c,v,r,t)] = round((cc_int(i,c,v,r,szn,t) + cc_iter(i,c,v,r,szn,t,"%previter%")) / 2 ,4) ;
    ) ;
