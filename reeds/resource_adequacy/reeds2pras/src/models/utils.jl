        ...
        if !(check_if_line_exists(dc_region_from, vsc_line.region_from, non_vsc_dc_lines))
            push!(
                ...
                Line(
                    ...
                    forward_cap = fill(vsc_line.converter_capacity[vsc_line.region_from], vsc_line.timesteps),
                    backward_cap = fill(vsc_line.converter_capacity[vsc_line.region_from], vsc_line.timesteps),
                    legacy = vsc_line.legacy,
                    FOR = vsc_line.FOR,
                    MTTR = vsc_line.MTTR,
                ),
        ...
        if !(check_if_line_exists(dc_region_to, vsc_line.region_to, non_vsc_dc_lines))
            push!(
                ...
                Line(
                    ...
                    forward_cap = fill(vsc_line.converter_capacity[vsc_line.region_to], vsc_line.timesteps),
                    backward_cap = fill(vsc_line.converter_capacity[vsc_line.region_to], vsc_line.timesteps),
                    legacy = vsc_line.legacy,
                    FOR = vsc_line.FOR,
                    MTTR = vsc_line.MTTR,
                ),
