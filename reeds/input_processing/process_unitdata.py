...
def main(inputs_case):
    ...
    unitdata.loc[(unitdata['tech']=='nuclear') & 
                 ((unitdata['status']== '(OP) Operating') | 
                  (unitdata['status']== '(OS) Out of service and NOT expected to return to service in next calendar year') | 
                  (unitdata['status']== '(OA) Out of service but expected to return to service in next calendar year') |
                  (unitdata['status']== '(SB) Standby/Backup: available for service but not normally used')) &
