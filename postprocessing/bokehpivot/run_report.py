...
output_dir = f'{bokehpivot_dir}/out/reeds_report_materials_coppervf' #This is the directory that will be created to contain the report. If it already exists, the existing directory will be archived with a date.
data_type = 'ReEDS 2.0'
