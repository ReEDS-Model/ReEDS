"""
Research-grade evaluation for ReEDS surrogate models.
...
def _render_report(
    ...
    md: list[str] = []
    md.append(f"# ReEDS surrogate evaluation report — *{cfg.layer}* layer\n")
    md.append(
...
<title>ReEDS surrogate evaluation — {cfg.layer}</title>
<style>
