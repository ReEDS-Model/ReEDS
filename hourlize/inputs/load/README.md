...
| filepaths | Paths to files containing exogenous sectoral load. |
...
| cooling_proportions_source | Filepath to hourly (weather year-specific), state-level proportions of data center demand that should be attributed to cooling. The file must have columns "weather_datetime", "state", and "cooling_prop".
