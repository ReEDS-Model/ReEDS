...
def add_classes(df_sc, class_path, class_bin, class_bin_col, class_bin_method, class_bin_num):
    ...
    if class_path is None:
        ...
        # Use object dtype so we can assign either int or str class labels
        # (newer pandas infers StringDtype from 'NA' and rejects ints).
...
def save_sc_outputs(
    ...
    extra_cols = [c for c in ['mean_resource_temp', 'mean_resource_depth'] if c in df_sc]
    df_sc_out = (
        df_sc[cols_out + extra_cols]
